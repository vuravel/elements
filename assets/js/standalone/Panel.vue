<template>
    ...
    <div :id="id" class="vlPanel">
        ...
        <transition :name="usedTransition" :mode="usedMode">
            ...
            <component v-if="partial" :is="partial" :vcomponent="component" :key="panelKey" />
        </transition>
...
export default {
    ...
    created(){
        ...
        this.$vuravel.events.$on('vlFillPanel' + this.id, (response, parentTrigger) => {
            this.component = null
            this.html = null
            this.partial = null

            if(parentTrigger && parentTrigger.include)
                return this.$emit('include', response) //emit and stop
