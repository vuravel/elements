...
export default {
    ...
    computed: {
        ...
        submitOnInputDebounce(){
            var submitOnInput = _.find(this.vcomponent.triggers['input'], (t) => t.action == 'submitForm')
            return submitOnInput ? submitOnInput.debounce : 0
        },
        filterOnInputDebounce(){
            var filterOnInput = _.find(this.vcomponent.triggers['input'], (t) => t.action == 'refreshCatalog')
            return filterOnInput ? filterOnInput.debounce : 0
        },
